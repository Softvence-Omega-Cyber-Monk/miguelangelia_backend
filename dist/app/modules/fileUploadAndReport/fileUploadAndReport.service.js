...
exports.FileReportService = {
  ...
  fileExplore: (data) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const uploaded = yield exports.FileReportService.uploadToCloudinary(
        data.file.path
      );
      ...
      const newReport =
        yield fileUploadAndReport_model_1.FileUploadAndReportModel.create({
          userId: data.userId,
  ...
  getReportAndSummry: (data) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (data.fileId) {
        newFileReport =
          yield fileUploadAndReport_model_1.FileUploadAndReportModel.findByIdAndUpdate(
            data.fileId,
            {
              summary: summaryData,
              report: report,
  ...
  getAllReportsByUser: (userId) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return yield fileUploadAndReport_model_1.FileUploadAndReportModel.find({
        userId: userId,
      }).sort({
        createdAt: -1,
      });
    }),
  getSummaryReportAndDashboardDataByUser: (fileId) =>
    __awaiter(void 0, void 0, void 0, function* () {
      // console.log('file id ', fileId);
      return yield fileUploadAndReport_model_1.FileUploadAndReportModel.find({
        _id: fileId,
      }).select("summary report dashboardData");
    }),
  deleteFile: (fileId) =>
    __awaiter(void 0, void 0, void 0, function* () {
      // console.log('file id ', fileId);
      const res =
        yield fileUploadAndReport_model_1.FileUploadAndReportModel.deleteOne({
          _id: fileId,
        });
      console.log(res);
      return res;
